                                          ...
                                          for (var i = 0; i < item.length; i++) {
                                                ...
                                                if (movieNm0 == title && openDt0 == reprlsdate) {
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc0).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt0).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange0 + "%";
                                                      console.log(typeof audiAcc0);
                                                      posterSrc.src = poster;
                                                      posterHref.href = poster;
                                                      console.log(poster);
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc1).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt1).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange1 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc2).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt2).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange2 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc3).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt3).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange3 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc4).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt4).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange4 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc5).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt5).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange5 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc6).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt6).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange6 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc7).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt7).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange7 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc8).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt8).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange8 + "%";
                                                      ...
                                                      audiAccValue.textContent = "누적관객수 "
                                                            + Number(audiAcc9).toLocaleString() + " 명";
                                                      audiCntValue.textContent = "전날관객수 "
                                                            + Number(audiCnt9).toLocaleString() + " 명";
                                                      audiChangeValue.textContent = "전날대비 "
                                                            + audiChange9 + "%";
