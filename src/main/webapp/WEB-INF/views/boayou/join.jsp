...
<div style="border:solid 1.5px gray; margin-top:100px;">
   <form
      action="${pageContext.servletContext.contextPath  }/boayou/InsertJoin"
      method="post">
      <div class="col-lg-12 text-center">
         ...
         <div class="box-input" style="text-indent: 85px;"  >

            <label for="user_id"></label> <input type="text" id="user_id"
               name="user_id" placeholder="아이디"> <input type="button"
               id="checkId" value="중복검사">


            <div>
               <span id="id_feedback" style="font-size: 12px;"></span>
            </div>
            <div class="box-line-height"></div>
            <br> <label for="pwd"></label> <input type="password" id="pwd"
               name="pwd" placeholder="비밀번호">
            <div class="box-line-height"></div>
            <br> <label for="pw-double"></label> 
            ...
            <div class="box-line-height"></div>
            <br> <label for="name"></label> <input type="text" id="name"
               name="name" placeholder="이름">
            <div class="box-line-height"></div>
            <br> <label for="age"></label> <input type="text" id="age"
               name="age" placeholder="나이">
            <div class="box-line-height"></div>
            <br> <label for="jumin"></label> <input type="text" id="jumin"
               name="jumin" placeholder="주민번호">
            <div class="box-line-height"></div>
            <br>
         ...
         <div class="box-submit">
            <input type="submit" value="가입" onclick="return verifyField();">
