                           ...
                           success : function(data2, textStatus) {
                              ...
                              for (var i = 0; i < item.length; i++) {
                                 ...
                                 if (movieNm0 == title) {
                                    ...
                                    docidHref.href = "${pageContext.request.contextPath}/boayou/movieInfoPage?movieCate=주간박스오피스&Docid="
                                          + docid;
                           ...
                           success : function(data2, textStatus) {
                              ...
                              for (var i = 0; i < item.length; i++) {
                                 ...
                                 if (movieNm0 == title) {
                                    ...
                                    posterSrc.src = poster;
                                    posterHref.href = poster;
                                    docidHref.href = "${pageContext.request.contextPath}/boayou/movieInfoPage?movieCate=일간박스오피스&Docid="
                                          + docid;
      ...
      <div class="container">
         <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
               ...
               <p>Boayou는 영화 정보를 알려드리고 커뮤니티 소통을 통해</p>
