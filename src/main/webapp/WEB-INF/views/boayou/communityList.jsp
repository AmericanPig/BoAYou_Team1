...
<title>CommunityList - 관리자 페이지</title>
...
<script>
	...
	function deleteBtn() {
	    ...
	    if (valueArr.length == 0) {
	        ...
	        $.ajax({
	            url: '/controller/boayou/communityDelete',
	            type : 'POST',
	            traditional : true,
				...
				<div class="row justify-content-between gy-4 mt-4">
					<div class="">
						<div class="d-flex">
								...
								<table>
									<thead>
										<tr>
											...
											<th>COMMUNITY_CONTENT</th>
										</tr>
									</thead>
									<tbody id="checkboxContainer">
										<c:forEach var="community" items="${communityList}">
											<tr>
												<td><input type="checkbox" name="checkRow"value="${community.community_no}"></td>
												<td>${community.community_no}</td>
												<td>${community.user_id}</td>
												<td>${community.docid}</td>
							...
							<%@ include file="../import/page-nation-comm.jsp" %>				
